...
gpg-sign health
gpg-sign admin list
gpg-sign public-key --key-id AFD5E3EC68371856 > public-key.asc
```
...
printf 'smoke test' |
  gpg-sign sign --key-id AFD5E3EC68371856 > smoke-test.asc
```
