/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b41af75546d5a3e00c4e78a60bc0bf5d)
// Runtime types generated with workerd@1.20260907.1 2026-07-12 nodejs_compat
interface __BaseEnv_Env {
	JWKS_CACHE: KVNamespace;
	AUDIT_DB: D1Database;
	KEY_EXPIRY_ALERTS: SendEmail;
	ALLOWED_ISSUERS: "https://token.actions.githubusercontent.com,https://gitlab.com";
	KEY_ID: "62E75E54497815DD" | "AFD5E3EC68371856";
	ENVIRONMENT?: "staging";
	KEY_EXPIRY_ALERT_FROM: "gpg-signing-service@kjanat.dev";
	KEY_EXPIRY_ALERT_TO: "info@kajkowalski.nl";
	GITHUB_APP_ENABLED: "false";
	GITHUB_APP_CHECK_RUNS: "false";
	GITHUB_APP_COMMENT_DISPATCH: "false";
	KEY_STORAGE: DurableObjectNamespace<import("./src/index").KeyStorage>;
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimiter>;
	WEBHOOK_DELIVERIES: DurableObjectNamespace<import("./src/index").WebhookDeliveries>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "KeyStorage" | "RateLimiter" | "WebhookDeliveries";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ISSUERS" | "KEY_ID" | "ENVIRONMENT" | "KEY_EXPIRY_ALERT_FROM" | "KEY_EXPIRY_ALERT_TO" | "GITHUB_APP_ENABLED" | "GITHUB_APP_CHECK_RUNS" | "GITHUB_APP_COMMENT_DISPATCH">> {}
}
