/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a78d326b925654e07d599a361bcd74f9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ISSUERS" | "KEY_ID">> {}
}
...
type ConversionResponse = { name: string; mimeType: string } & (
  | { format: "markdown"; tokens: number; data: string }
